...
@Transactional
public class PosNegNoInfoAndRulesChallengeProcessorIntegrationTest {

	@Autowired
	@Qualifier("fraudCheckProcessor")
	private FraudCheckProcessor fraudCheckProcessor;

	String posNegNolnfoAndRulesChallengeXml;
	...
	public void setUp() throws Exception {
		posNegNolnfoAndRulesChallengeXml = ConvertTestXmlToString.convertTestXmltoString(this.getClass()
				.getResource("/testfile/from_oms/noinfo_challenge.xml").getPath());
	}
	...
	@Test
	public void testPosNegNoInfoAndRulesChallengeProcessor() throws Exception {
		fraudCheckProcessor.omsProcess(getMessage(posNegNolnfoAndRulesChallengeXml));
